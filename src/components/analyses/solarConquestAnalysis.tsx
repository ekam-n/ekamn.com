...
export default function SolarConquestAnalysis() {
  return (
    <main className="max-w-6xl mx-auto px-4 pt-20 pb-16 text-white">
      ...
      <div className="space-y-4 md:space-y-6">
        <Row cols={1}>
          <Card title="Initial Systems Design">
      ...
      <div className="space-y-4 md:space-y-6">
        <Row cols={1}>
          <Card title="Key Changes to Systems">
            <ul className="list-disc pl-5 space-y-4">
      ...
      <div className="space-y-4 md:space-y-6">
        <Row cols={1}>
          <Card title="Final Systems Design">
            <ul className="list-disc pl-5 space-y-4">
      ...
      <div className="space-y-4 md:space-y-6">
        <Row cols={1}>
          <Card title="Takeaways">
            <ul className="list-disc pl-5 space-y-4">
                  <li>I learned how hard it is to balance game systems: it took lots of playtesting and analysis to keep player agency high, chance vs strategy in equilibrium, and multiple viable paths to win.</li>
